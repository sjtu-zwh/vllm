...
async def benchmark(
    ...
    async for request in get_request(input_requests[-10:], request_rate, burstiness):
...
def main(args: argparse.Namespace):
    ...
    if args.trace_name is not None:
        ...
        num_prompts = args.num_prompts + 10
